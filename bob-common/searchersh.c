...
int main(int argc, char *argv[]) {
    ...
    if (command == NULL) {
        ...
        fprintf(stderr, "No command provided. Valid commands are: toggle, status, logs, tail-the-logs, restart-lighthouse, reboot, initialize\n");
    ...
    // If command == "reboot", reboot the host machine
        ...
        execl("/usr/bin/sudo", "sudo", "/usr/bin/reboot", NULL);
    ...
    fprintf(stderr, "Invalid command. Valid commands are: toggle, status, logs, tail-the-logs, restart-lighthouse, reboot, initialize\n");
