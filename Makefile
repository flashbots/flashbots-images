...
.PHONY: all build build-dev setup measure measure-portable measure-portable-gcp clean check-module test-gcp-packaging
...
test-gcp-packaging: ## Verify deterministic GCP archive creation
	@scripts/test_gcp_postoutput_reproducible.sh
