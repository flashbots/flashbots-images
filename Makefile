...
.PHONY: all build build-dev setup measure measure-portable measure-portable-gcp clean check-module test-debian-snapshot
...
test-debian-snapshot: ## Verify Debian repositories use pinned signature trust
	@scripts/test_debian_snapshot_configuration.sh
